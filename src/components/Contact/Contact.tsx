...
const Contact: FC = () => {
    return (
        <ContactSection>
            ...
            <ContactLine/>
            <script>var accountId = "35347";var
                formId = "0ea0194e-db01-4ec2-81d1-4f0f8550f840";var
                marketingDomain = "marketing.polarispacific.com";
            </script>

            <script type="text/javascript"
                    src="//a11058.actonservice.com/cdnr/67/acton/attachment/11058/f-0083/1/-/-/-/-/WPCF7Script.js"></script>
            <script type="text/javascript"
                    id="aoform-script-0ea0194e-db01-4ec2-81d1-4f0f8550f840:d-0001">{!function (o, t, e, a) {
